...
public class ContactsView extends FrameView {
    ...
    public ContactsView(SingleFrameApplication app) {
        super(app);
        initComponents();
        jList1.setModel(dynamicContacts);
    }
    ...
    public ListModel dynamicContacts = new AbstractListModel(){
        public int getSize() {updateList(); return SODApp.getApplication().contactcontroller.getNumContacts();}
        public Object getElementAt(int i){return SODApp.getApplication().contactcontroller.getAllNames()[i];}
    };

    public void updateList(){
        jList1.setListData(SODApp.getApplication().contactcontroller.getAllNames());
    }
