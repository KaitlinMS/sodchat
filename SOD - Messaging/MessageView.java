...
private Socket [] contacts;
    ...
    private void initComponents() {
        ...
        jTextPane1.setText(org.jdesktop.application.Application.getInstance().getContext().getResourceMap(MessageView.class).getString("jTextPane1.text")); // NOI18N
