...
public class SODApp extends SingleFrameApplication {
    ...
    @Override protected void startup() {
        ...
        contactcontroller.addContact("192.168.2.13", "Jim", "Joe");
        contactcontroller.addContact("192.168.2.13", "Jim", "Joe");
        contactcontroller.addContact("192.168.2.13", "Jim", "Joe");
        contactcontroller.addContact("192.168.2.13", "Jim", "Joe");
    ...
    public void newMessage(){
     ...
     public void addContact(String IP, String Name){
        contactcontroller.addContact(IP, Name, setSet.getUserName());
        System.out.println(contactcontroller.getAllNames()[0]);
        //contacts.updateList(contactcontroller.getAllNames());
     }

     public void removeContact(int i){
        if (i != -1) contactcontroller.removeContact(i);
        //contacts.updateList(contactcontroller.getAllNames());
     }
}
